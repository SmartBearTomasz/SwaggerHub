...
{ 
    ...
    { 
        ...
        [HttpPost]
        [Route("/TomaszZoo/TomaszApi/1.0.0/pet")]
        [ValidateModelState]
        ...
        [HttpDelete]
        [Route("/TomaszZoo/TomaszApi/1.0.0/pet/{petId}")]
        [ValidateModelState]
        ...
        [HttpGet]
        [Route("/TomaszZoo/TomaszApi/1.0.0/pet/findByStatus")]
        [ValidateModelState]
        ...
        [HttpGet]
        [Route("/TomaszZoo/TomaszApi/1.0.0/pet/findByTags")]
        [ValidateModelState]
        ...
        /// <response code="200">successful operation</response>
        [HttpPost]
        [Route("/TomaszZoo/TomaszApi/1.0.0/pet/{petId}/uploadImage")]
        [ValidateModelState]
